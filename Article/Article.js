...
*/
function createComponent({ title, date, paragraphOne, paragraphTwo, paragraphThree}){
  ...
  articleParagraph1 = paragraphOne;
  articleParagraph2 = paragraphTwo;
  articleParagraph3 = paragraphThree;
